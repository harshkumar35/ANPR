    ...
    var n, e = {
            3856: function(n, e, t) {
                var o = gform.utils,
                    ...
                    c = window.gform_theme_config,
                    a = {},
                    d = function(n) {
                        var e = n.target;
                        if ((w(e) || f(e)) && !m()) {
                            var t = '<input type="hidden" name="version_hash" value="'.concat(c.common.form.honeypot.version_hash, '" />');
                    ...
                    w = function(n) {
                        var e = n.dataset.formid,
                            t = (0, o.getNodes)('input[name = "gform_target_page_number_'.concat(e, '"]'), !0, n, !0)[0];
                        return void 0 !== t && 0 === parseInt(t.value)
                    },
                    m = function() {
                    ...
                    s = function() {
                        a.forms = (0, o.getNodes)(".gform_wrapper form", !0, document, !0), a.forms.forEach((function(n) {
                            return jQuery(document).on("submit", n, d)
                        })), (0, o.consoleInfo)("Gravity Forms Honeypot: Initialized.")
                    },
                    l = function() {
                        s(), (0, o.consoleInfo)("Gravity Forms Form JS: Initialized..")
                    },
                    _ = function() {
                        u(), l()
                    },
    ...
    o.m = e, n = [], o.O = function(e, t, r, i) {
            if (!t) {
                ...
                for (f = 0; f < n.length; f++) {
                    ...
                    for (var c = !0, a = 0; a < t.length; a++)(!1 & i || u >= i) && Object.keys(o.O).every((function(n) {
                        return o.O[n](t[a])
                    })) ? t.splice(a--, 1) : (c = !1, i < u && (u = i));
                    if (c) {
                        n.splice(f--, 1);
                        var d = r();
                        void 0 !== d && (e = d)
            ...
            i = i || 0;
            for (var f = n.length; f > 0 && n[f - 1][2] > i; f--) n[f] = n[f - 1];
            n[f] = [t, r, i]
        }, o.n = function(n) {
            ...
            for (var t in e) o.o(e, t) && !o.o(n, t) && Object.defineProperty(n, t, {
                enumerable: !0,
                get: e[t]
            })
        }, o.g = function() {
        ...
        function() {
            ...
            n = n.replace(/#.*$/, "").replace(/\?.*$/, "").replace(/\/[^\/]+$/, "/"), o.p = n
        }(),
        function() {
            var n = {
                415: 0
            ...
            var e = function(e, t) {
                    ...
                    for (e && e(t); d < u.length; d++) i = u[d], o.o(n, i) && n[i] && n[i][0](), n[i] = 0;
                    return o.O(f)
                },
